...
This document provides guidelines for internationalization of the AITTCoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `aittcoin_en.ts` remains unchanged.
