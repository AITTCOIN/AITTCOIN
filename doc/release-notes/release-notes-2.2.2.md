AITTCoin Core version *2.2.2* is now available!!
==============

  <https://github.com/AITTCoinProject/AITTCOIN/releases/tag/v2.2.2>
...
- Enhancements for AITTCOIN Dev Kit and Mobile Wallet Support
...
Changelog available here: <https://github.com/AITTCoinProject/AITTCOIN/commits/release_2.2.2>
