AITTCoin Core version *2.1.0* is now available!!
==============

  <https://github.com/AITTCoinProject/AITTCOIN/releases/tag/v2.1.0>
...
Changelog available here: <https://github.com/AITTCoinProject/AITTCOIN/commits/release_2.1.0>
