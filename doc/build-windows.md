...
Below are some notes on how to build AITTCoin Core for Windows.
...
way. This will install to `c:\workspace\aittcoin`, for example:

    make install DESTDIR=/mnt/c/workspace/aittcoin
