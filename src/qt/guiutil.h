...
#ifndef AITTCOIN_QT_GUIUTIL_H
#define AITTCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the AITTCoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "aittcoin:" URI into recipient object, return true on successful parsing
