...
#ifndef AITTCOIN_QT_AITTCOINAMOUNTFIELD_H
#define AITTCOIN_QT_AITTCOINAMOUNTFIELD_H
...
/** Widget for entering aittcoin amounts.
  */
class AITTCOINAmountField: public QWidget
{
    Q_OBJECT
...
public:
    explicit AITTCOINAmountField(QWidget *parent = 0);
...
#endif // AITTCOIN_QT_AITTCOINAMOUNTFIELD_H
