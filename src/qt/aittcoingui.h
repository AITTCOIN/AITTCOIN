...
#ifndef AITTCOIN_QT_AITTCOINGUI_H
#define AITTCOIN_QT_AITTCOINGUI_H
...
/**
  AITTCoin GUI main class. This class represents the main window of the AITTCoin UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class AITTCoinGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit AITTCoinGUI(const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = 0);
    ~AITTCoinGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a aittcoin wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
private:
    ...
    QComboBox *comboAITTUnit = nullptr;
...
#endif // AITTCOIN_QT_AITTCOINGUI_H
