...
public:
    explicit TxViewDelegate(const PlatformStyle *_platformStyle, QObject *parent=nullptr):
        QAbstractItemDelegate(parent), unit(AITTCoinUnits::AITT),
    ...
    assetdelegate(new AssetViewDelegate(platformStyle, this))
{
    ...
    ui->aittBalancesLabel->setStyleSheet(STRING_LABEL_COLOR);
    ...
    ui->aittBalancesLabel->setFont(GUIUtil::getTopLabelFont());
...
void OverviewPage::setBalance(const CAmount& balance, const CAmount& unconfirmedBalance, const CAmount& immatureBalance, const CAmount& watchOnlyBalance, const CAmount& watchUnconfBalance, const CAmount& watchImmatureBalance)
{
    ...
    ui->labelBalance->setText(AITTCoinUnits::formatWithUnit(unit, balance, false, AITTCoinUnits::separatorAlways));
    ui->labelUnconfirmed->setText(AITTCoinUnits::formatWithUnit(unit, unconfirmedBalance, false, AITTCoinUnits::separatorAlways));
    ui->labelImmature->setText(AITTCoinUnits::formatWithUnit(unit, immatureBalance, false, AITTCoinUnits::separatorAlways));
    ui->labelTotal->setText(AITTCoinUnits::formatWithUnit(unit, balance + unconfirmedBalance + immatureBalance, false, AITTCoinUnits::separatorAlways));
    ui->labelWatchAvailable->setText(AITTCoinUnits::formatWithUnit(unit, watchOnlyBalance, false, AITTCoinUnits::separatorAlways));
    ui->labelWatchPending->setText(AITTCoinUnits::formatWithUnit(unit, watchUnconfBalance, false, AITTCoinUnits::separatorAlways));
    ui->labelWatchImmature->setText(AITTCoinUnits::formatWithUnit(unit, watchImmatureBalance, false, AITTCoinUnits::separatorAlways));
    ui->labelWatchTotal->setText(AITTCoinUnits::formatWithUnit(unit, watchOnlyBalance + watchUnconfBalance + watchImmatureBalance, false, AITTCoinUnits::separatorAlways));
...
void OverviewPage::setWalletModel(WalletModel *model)
{
    ...
    // update the display unit, to not use the default ("AITT")
    updateDisplayUnit();
}
...
void OverviewPage::showAssets()
{
    if (AreAssetsDeployed()) {
        ...
        // This keeps the AITT balance grid from expanding and looking terrible when asset balance is hidden
