...
#ifndef AITTCOIN_QT_AITTCOINUNITS_H
#define AITTCOIN_QT_AITTCOINUNITS_H
...
/** AITTCoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class AITTCoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit AITTCoinUnits(QObject *parent);
...
typedef AITTCoinUnits::Unit AITTCoinUnit;

#endif // AITTCOIN_QT_AITTCOINUNITS_H
