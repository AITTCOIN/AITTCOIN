...
#include "qt/aittcoinamountfield.h"
...
uint256 SendCoins(CWallet& wallet, SendCoinsDialog& sendCoinsDialog, const CTxDestination& address, CAmount amount, bool rbf)
{
    ...
    entry->findChild<AITTCOINAmountField*>("payAmount")->setValue(amount);
...
//
//     src/qt/test/test_aittcoin-qt -platform xcb      # Linux
//     src/qt/test/test_aittcoin-qt -platform windows  # Windows
//     src/qt/test/test_aittcoin-qt -platform cocoa    # macOS
void TestGUI()
{
    ...
    QString balanceComparison = AITTCoinUnits::formatWithUnit(unit, balance, false, AITTCoinUnits::separatorAlways);
    ...
    // Amount input
    AITTCOINAmountField* amountInput = receiveCoinsDialog.findChild<AITTCOINAmountField*>("reqAmount");
    ...
    for (QWidget* widget : QApplication::topLevelWidgets()) {
        if (widget->inherits("ReceiveRequestDialog")) {
            ...
            QVERIFY(paymentTextList.at(1).indexOf(QString("URI: aittcoin:")) != -1);
