...
#ifndef AITTCOIN_QT_RECEIVECOINSDIALOG_H
#define AITTCOIN_QT_RECEIVECOINSDIALOG_H
...
/** Dialog for requesting payment of aittcoins */
...
#endif // AITTCOIN_QT_RECEIVECOINSDIALOG_H
