    ...
    mapper(0)
{
    ...
    ui->aittcoinAtStartup->setToolTip(ui->aittcoinAtStartup->toolTip().arg(tr(PACKAGE_NAME)));
    ui->aittcoinAtStartup->setText(ui->aittcoinAtStartup->text().arg(tr(PACKAGE_NAME)));

    ui->openAITTCOINConfButton->setToolTip(ui->openAITTCOINConfButton->toolTip().arg(tr(PACKAGE_NAME)));
    ...
    ui->unit->setModel(new AITTCoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->aittcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openAITTCOINConfButton_clicked()
{
