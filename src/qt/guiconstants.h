...
#ifndef AITTCOIN_QT_GUICONSTANTS_H
#define AITTCOIN_QT_GUICONSTANTS_H
...
/* AITTCoinGUI -- Size of icons in status bar */
...
/* AITTCOIN dark orange */
#define COLOR_DARK_ORANGE QColor("#f05239")
/* AITTCOIN light orange */
...
/* AITTCOIN shadow color - light mode */
...
/* AITTCOIN label color as a string */
...
#define QAPP_ORG_NAME "AITTCoin"
#define QAPP_ORG_DOMAIN "aittcoin.org"
#define QAPP_APP_NAME_DEFAULT "AITTCoin-Qt"
#define QAPP_APP_NAME_TESTNET "AITTCoin-Qt-testnet"

/* Default third party browser urls */
#define DEFAULT_THIRD_PARTY_BROWSERS "https://explorer.aittcoin.org/tx/%s"

/* Default IPFS viewer */
#define DEFAULT_IPFS_VIEWER "https://ipfs.io/ipfs/%s"

#endif // AITTCOIN_QT_GUICONSTANTS_H
