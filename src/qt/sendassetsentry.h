...
#ifndef AITTCOIN_QT_SENDASSETSENTRY_H
#define AITTCOIN_QT_SENDASSETSENTRY_H
...
/**
 * A single entry in the dialog for sending aittcoins.
...
#endif // AITTCOIN_QT_SENDASSETSENTRY_H
