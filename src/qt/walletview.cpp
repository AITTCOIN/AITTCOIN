...
void WalletView::setAITTCoinGUI(AITTCoinGUI *gui)
{
    if (gui)
    {
...
void WalletView::setWalletModel(WalletModel *_walletModel)
{
    ...
    if (_walletModel)
    {
        ...
        // update HD status
        Q_EMIT hdEnabledStatusChanged(_walletModel->hd44Enabled() ? AITTCoinGUI::HD44_ENABLED : _walletModel->hdEnabled() ? AITTCoinGUI::HD_ENABLED : AITTCoinGUI::HD_DISABLED);
