...
#ifndef AITTCOIN_QT_OPTIONSMODEL_H
#define AITTCOIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for AITTCoin client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,             // QString
        ProxyPortTor,           // int
        DisplayUnit,            // AITTCoinUnits::Unit
...
#endif // AITTCOIN_QT_OPTIONSMODEL_H
