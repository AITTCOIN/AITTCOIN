...
#ifndef AITTCOIN_ASSET_PROTOCOL_H
#define AITTCOIN_ASSET_PROTOCOL_H
...
bool CheckIssueDataTx(const CTxOut& txOut); // OP_AITTCOIN_ASSET AITTQ (That is a Q as in Que not an O)
bool CheckOwnerDataTx(const CTxOut& txOut);// OP_AITTCOIN_ASSET AITTO
bool CheckReissueDataTx(const CTxOut& txOut);// OP_AITTCOIN_ASSET AITTR
bool CheckTransferOwnerTx(const CTxOut& txOut);// OP_AITTCOIN_ASSET AITTT
...
#endif //AITTCOIN_ASSET_PROTOCOL_H
