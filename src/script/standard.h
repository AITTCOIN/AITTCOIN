...
#ifndef AITTCOIN_SCRIPT_STANDARD_H
#define AITTCOIN_SCRIPT_STANDARD_H
...
enum txnouttype
{
    ...
    TX_RESTRICTED_ASSET_DATA = 11, //!< unspendable OP_AITTCOIN_ASSET script that carries data
    /** AITT END */
};
 ...
 *  A CTxDestination is the internal data type encoded in a AITTCOIN address
 */
...
/**
 * Generate a AITTCoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // AITTCOIN_SCRIPT_STANDARD_H
