...
#ifndef AITTCOIN_CHAINPARAMS_H
#define AITTCOIN_CHAINPARAMS_H
 ...
 * AITTCoin system. There are three: the main network on which people trade goods
...
public:
    ...
    const std::string& OrgAddress() const { return strOrgAddress; }
