 ...
 */
#ifndef AITTCOIN_UTIL_H
#define AITTCOIN_UTIL_H
...
extern const char *const AITTCOIN_CONF_FILENAME;
extern const char *const AITTCOIN_PID_FILENAME;
...
{
    std::string s = strprintf("aittcoin-%s", name);
