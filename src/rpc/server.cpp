...
CAmount AmountFromValue(const UniValue& value, bool p_isAITT)
{
...
UniValue stop(const JSONRPCRequest& jsonRequest)
{
    ...
    return "AITTCoin server stopping";
}
...
{
    return "> aittcoin-cli " + methodname + " " + args + "\n";
}
