...
#ifndef AITTCOIN_RPCSERVER_H
#define AITTCOIN_RPCSERVER_H
...
/**
 * AITTCoin RPC command dispatcher.
 */
class CRPCTable
{
private:
...
extern CAmount AmountFromValue(const UniValue& value, bool p_isAITT = true);
