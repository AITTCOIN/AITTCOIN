...
BOOST_FIXTURE_TEST_SUITE(restricted_tests, BasicTestingSetup)
    ...
    BOOST_AUTO_TEST_CASE(verify_new_restricted_transaction_test) {
        ...
        // Create filler fib tx
        CScript aittTransfer = GetScriptForDestination(DecodeDestination(GetParams().GlobalBurnAddress()));
        CTxOut aittOut(1*COIN, aittTransfer);
        ...
        mutTxTest1.vout.emplace_back(aittOut);
        ...
        mutTxTest2.vout.emplace_back(aittOut);
        ...
        mutTxTest3.vout.emplace_back(aittOut);
        ...
        mutTxTest4.vout.emplace_back(aittOut);
        ...
        mutTxTest5.vout.emplace_back(aittOut);
        ...
        mutTxTest6.vout.emplace_back(aittOut);
        ...
        mutTxTest7.vout.emplace_back(aittOut);
        ...
        mutTxTest8.vout.emplace_back(aittOut);
