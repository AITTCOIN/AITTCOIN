...
#ifndef AITTCOIN_TEST_SCRIPTNUM10_H
#define AITTCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from AITTCoin Core 0.10.0, for cross-comparison.
 */
public:
