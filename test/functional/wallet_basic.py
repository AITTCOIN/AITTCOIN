...
class WalletTest(AITTCoinTestFramework):
    ...
    def run_test(self):
        ...
        # Send 21 AITT from 0 to 2 using sendtoaddress call.
        ...
        # Send 10 AITT with subtract fee from amount
        ...
        # Sendmany 10 AITT with subtract fee from amount
