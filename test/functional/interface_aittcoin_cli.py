...
class TestAITTCoinCli(AITTCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getinfo RPC and `aittcoin-cli getinfo`")
        ...
        self.log.info("Compare responses from `aittcoin-cli -getinfo` and the RPCs data is retrieved from.")
