...
import os
import struct
from test_framework.test_framework import AITTCoinTestFramework, SkipTest
...
# noinspection PyUnresolvedReferences
class ZMQTest(AITTCoinTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that aittcoin has been built with ZMQ enabled.
        ...
        if not config["components"].getboolean("ENABLE_ZMQ"):
            raise SkipTest("aittcoind has not been built with zmq enabled.")
