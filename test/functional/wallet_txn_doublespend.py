...
class TxnMallTest(AITTCoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 AITT:
        ...
        # First: use raw transaction API to send 1240 AITT to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 AITT coin each
        ...
        # Node0's balance should be starting balance, plus 50AITT for another
        ...
        # Node0's total balance should be starting balance, plus 100AITT for 
