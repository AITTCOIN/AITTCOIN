...
# TestNode: A peer we use to send messages to aittcoind, and store responses.
...
class CompactBlocksTest(AITTCoinTestFramework):
    ...
    # This test actually causes aittcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that aittcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for aittcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(node, test_node, version):
        # aittcoind will not send blocktxn responses for blocks whose height is
