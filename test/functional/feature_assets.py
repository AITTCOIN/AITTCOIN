...
class AssetTest(AITTCoinTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("AITTCOIN1", 1000)
        n0.issue("AITTCOIN2", 1000)
        n0.issue("AITTCOIN3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="AITTCOIN*", verbose=False, count=2, start=-2)
        ...
        aittcoin_assets = n0.listassets(asset="AITTCOIN*", verbose=False, count=2, start=-2)
        assert_equal(len(aittcoin_assets), 2)
        assert_equal(aittcoin_assets[0], "AITTCOIN2")
        assert_equal(aittcoin_assets[1], "AITTCOIN3")
        self.sync_all()
