...
class BIP66Test(AITTCoinTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # aittcoind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and aittcoind produces more specific reject
            # reasons.
