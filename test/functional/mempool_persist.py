...
By default, aittcoind will dump mempool on shutdown and
...
class MempoolPersistTest(AITTCoinTestFramework):
    ...
    def run_test(self):
        ...
        self.start_node(0)
        self.start_node(1)
        # Give aittcoind a second to reload the mempool
        time.sleep(1)
        ...
        self.log.debug("Prevent aittcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
