...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the AITTCoinTestFramework
    pass

class ExampleTest(AITTCoinTestFramework):
    # Each functional test is a subclass of the AITTCoinTestFramework class.
    ...
    def custom_method(self):
        ...
        AITTCoinTestFramework class so other tests can use it."""
