...
find ${DISTNAME}/bin -type f -executable -exec ../AITTCOIN/contrib/devtools/split-debug.sh {} {} {}.dbg \;
find ${DISTNAME}/lib -type f -exec ../AITTCOIN/contrib/devtools/split-debug.sh {} {} {}.dbg \;
...
mkdir -p ~/AITTCOIN/depends/SDKs
cp ~/MacOSX10.11.sdk.tar.gz ~/AITTCOIN/depends/SDKs/MacOSX10.11.sdk.tar.gz
